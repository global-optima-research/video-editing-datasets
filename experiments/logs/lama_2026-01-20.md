...
| 原始帧 | 原始 Mask (仅轮廓) | 膨胀后 Mask |
|--------|-------------------|-------------|
| ![原始帧](../results/lama/frame_000_original.png) | ![原始mask](../results/lama/frame_000_mask.png) | ![膨胀mask](../results/lama/frame_000_mask_dilated.png) |
...
| Frame 0 | Frame 100 |
|---------|-----------|
| ![frame0](../results/lama/v2_frame_001.png) | ![frame100](../results/lama/v2_frame_003.png) |

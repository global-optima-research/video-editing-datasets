# Wan2.2 TI2V 运动迁移方案验证

> **状态**: ❌ 已放弃 - 该方案不可行，已切换到 ProductVideoGenerator 方案
> **后续方案**: [product_video_generator_2026-01-23.md](../logs/product_video_generator_2026-01-23.md)
...
> **更新 (2026-01-23)**: 已切换到全新方案，绕过运动迁移问题

~~1. **RF-Solver Inversion + TI2V**: 从源视频提取运动 latent，迁移到目标首帧~~
~~2. **FlowEdit/FlowAlign**: 直接在视频层面编辑~~
~~3. **Motion Transfer 模型**: 专门的运动迁移方法~~

**当前采用方案**: ProductVideoGenerator (Wan2.1-VACE-1.3B)
- 使用 masked_video + 多视角商品图片训练
- 模型学会将商品"插入"到 masked 区域
- 详见 [product_video_generator_2026-01-23.md](../logs/product_video_generator_2026-01-23.md)
